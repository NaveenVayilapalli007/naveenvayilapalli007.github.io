...
const SKILLS = [
  ...
  { name:'Databricks',    cat:'big-data', icon:'🧱', lvl:87 },
  { name:'Delta Lake',    cat:'big-data', icon:'🏔', lvl:85 },
  { name:'dbt',           cat:'big-data', icon:'🔧', lvl:76 },
  { name:'Structured Streaming', cat:'big-data', icon:'🌊', lvl:80 },
  { name:'AWS',           cat:'cloud',    icon:'☁️', lvl:82 },
